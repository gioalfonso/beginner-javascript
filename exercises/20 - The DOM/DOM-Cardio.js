...
function generatePlayerCard(name, age, height) {
  const html = `
    <div class="playerCard">
      <h2>${name} - ${age}</h2>
      <p>
      Their HEIGHT IS ${height} and ${age} years old. In Dog years
      this person would be ${age * 7}.  That
      would be a tall dog!
      </p>
...
//       In Dog years this person would be AGEINDOGYEARS. That would be a tall dog!</p>
// </div>
